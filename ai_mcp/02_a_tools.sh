...
```sh
sudo mkdir -p /app/backend_mcp && cd /app/backend_mcp/
ls -al
sudo chmod -R 755 /app/backend_mcp/
sudo chown adminuser:adminuser /app/backend_mcp/
touch .env.mcp-auth-service
nano docker-compose.yml
```
- setup frontend
```sh
sudo mkdir -p /app/frontend_mcp/&& cd /app/frontend_mcp/
ls -al
sudo chmod -R 755 /app/frontend_mcp/
sudo chown adminuser:adminuser /app/frontend_mcp/
touch .env.frontend
nano docker-compose.yml
```